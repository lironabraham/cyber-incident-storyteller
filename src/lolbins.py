"""
MITRE ATT&CK mapping for suspicious commands (Living off the Land Binaries).

Contains command → (technique_id, name) mappings for 140+ suspicious binaries,
scripts, and system utilities commonly used in attacks.
"""
